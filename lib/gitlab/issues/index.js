...
exports.update = function(args, next) {
    var IssueUpdate = require('./processes/update-issue');

    var application = new IssueUpdate(args);
    application.update(next);
};

exports.sync = function(args, next) {
    var IssueSync = require('./processes/sync-issue');

    var application = new IssueSync(args);
    application.sync(next);
};
